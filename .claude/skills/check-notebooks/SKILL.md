...
```bash
python3 ${CLAUDE_SKILL_DIR}/check_notebooks.py            # all chap*.ipynb in chapters/ and blank/, plus TOC/links/workflow glob
...
and TOC notebooks not matched by the `cp` glob in `.github/workflows/deploy-book.yml`.
